        ...
        <section id="projects" className="projects-section">
          ...
          <div className="projects-grid">
            <div className="project-card">
              ...
              <p>🔗 <a href="https://mackerelpacks.com/runes-rocket/" target="_blank" rel="noopener noreferrer">View Project</a></p>
              <p>🛠 Tech Used: JavaScript, React, Node.js</p>
            </div>
            <div className="project-card">
              <h3>🤖 Telegram Bots</h3>
              <p><i>Developed multiple bots for various use cases, from automation to real-time data fetching.</i></p>
              <p>🔗 <a href="https://mackerelpacks.com/runes-rocket/" target="_blank" rel="noopener noreferrer">View Project</a></p>
              <p>🛠 Tech Used: Python, SQLite, PostgreSQL, Python-Telegram-Bot, Telegram API</p>
            </div>
            <div className="project-card">
