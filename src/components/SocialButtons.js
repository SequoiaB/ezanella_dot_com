...
const SocialButtons = ({ 
  githubUsername = 'SequoiaB',  
  linkedinUsername = 'edoardozanella', 
  twitterUsername = 'bc1pEddi',  
  telegramUsername = 'bc1pEddi'  
}) => {
  return (
    <StyledWrapper className="social-buttons-container">
      <ul className="wrapper social-icons">
        ...
        <li className="icon linkedin">
          ...
          <a href={`https://linkedin.com/in/${linkedinUsername}`} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
        ...
        <li className="icon twitter">
          ...
          <a href={`https://twitter.com/${twitterUsername}`} target="_blank" rel="noopener noreferrer" aria-label="Twitter">
            <svg height="1.2em" fill="currentColor" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        ...
        <li className="icon telegram">
          ...
          <a href={`https://t.me/${telegramUsername}`} target="_blank" rel="noopener noreferrer" aria-label="Telegram">
